...
def generate_microservice(source_file, dest_dir=None, llm_url=None, port=8000):
    """
    ...
    Args:
        ...
        port (int, optional): Port number for the microservice (default: 8000)
    ...
    # Update the CMD in dockerfile to use the specified port
    dockerfile_content = Template(DOCKERFILE_TEMPLATE).substitute(
        port=str(port)
    )
    ...
    # Create app.py with the specified port
